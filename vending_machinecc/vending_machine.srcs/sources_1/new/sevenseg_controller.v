...
module sevenseg_controller (
    ...
    function [63:0] error_label_chars;
        input [3:0] error_code;
        begin
            case (error_code)
                `ERR_INVALID_INPUT:  error_label_chars = {"I","N","P","U","T","E","R","R"};
                `ERR_WRONG_PASSWORD: error_label_chars = {"P","A","S","S"," ","E","R","R"};
                `ERR_ITEM_OFF:       error_label_chars = {"O","F","F","E","R","R","O","R"};
                `ERR_NO_STOCK:       error_label_chars = {"S","T","O","C","K","E","R","R"};
                `ERR_NOT_ENOUGH:     error_label_chars = {"M","O","N","E","Y","E","R","R"};
                default:             error_label_chars = {"U","N","K","N","E","R","R"," "};
            endcase
        end
    endfunction
        ...
        if (ui_alarm_active || (ui_page == UI_PAGE_ALARM)) begin
            ...
            case (ui_page)
                ...
                UI_PAGE_SALE_ERROR: begin
                    ...
                    bottom_row_chars = error_label_chars(ui_error_code);
                end
