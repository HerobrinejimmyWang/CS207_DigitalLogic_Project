...
// Shared error codes and display meanings.
`define ERR_NONE             4'd0
`define ERR_INVALID_INPUT    4'd1  // Input error.
`define ERR_WRONG_PASSWORD   4'd2  // Password error.
`define ERR_ITEM_OFF         4'd3  // Item-off error.
`define ERR_NO_STOCK         4'd4  // No-stock error.
`define ERR_NOT_ENOUGH       4'd5  // Payment error.
